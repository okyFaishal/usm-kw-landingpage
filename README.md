...
> **🚀 Live Demo Berjalan:** Anda dapat melihat dan mencoba hasil langsung (_deployed version_) dari proyek ini di tautan berikut:
...
- 📱 **Desain UI/UX Modern & Responsif:** Komponen menggunakan navigasi model `glassmorphism`, efek _hover_ interaktif, dan disesuaikan semaksimal mungkin untuk tampil prima di _smartphone_ maupun dekstop.
...
- 🔗 **Tautan Pintas Terpusat:** Penempatan strategis untuk akses sistem E-Learning, SIMA, Peta Kampus, dan Media Sosial Resmi di bagian _Footer_.

---

## 🛠️ Teknologi & Arsitektur

Proyek ini dibangun menggunakan pilar _front-end_ modern tanpa _framework_ berat untuk menjaga performa optimal:

- **Struktur:** HTML5 Semantik.
- **Desain & Gaya:** CSS murni / Vanilla CSS (dengan adopsi pola kelas utilitas ala _Tailwind_ secara kustom).
...
- **Tipografi:** Google Fonts (seperti font _Poetsen One_, _Inter_, dll).
...
Proyek ini bersifat statis, sehingga sangat mudah untuk dijalankan di lingkungan lokal Anda tanpa instalasi _dependency_ yang rumit (_No Node.js/NPM required_ untuk _runtime_ dasar).
...
3. **Jalankan Aplikasi:**
   ...
   > 💡 _Saran:_ Untuk pengalaman pengembangan terbaik, gunakan fitur **Live Server** di VS Code untuk melihat perubahan secara waktu nyata (_real-time_).
